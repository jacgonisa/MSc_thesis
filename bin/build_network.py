...
if args.cleaning is not None:
    ...
    cleanFile = re.sub("\..*$", ".clean", args.file_in)
    ...
    print("  Cleaned file exported to: '", re.sub("\..*$", ".clean", args.file_in), "'", sep="")

# Setting name of input file
if args.cleaning:
    input_file = re.sub("\..*$", ".clean", args.file_in)
else:
